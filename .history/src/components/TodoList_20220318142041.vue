<template>
    <div>
        ...
        <main>
            ...
            <ul>
                <todo-item v-for="(todo, index) in todosFiltered" :key="todo.id" :todo="todo" :index="index" @removedTodo="removeTodo" @finishEdit="finishEdit">
                    <!-- <div class="todo-item-left">
                        <input type="checkbox" class="active-item" v-model="todo.complete">
                        <div v-if="!todo.editing" class="todo-item-label" :class="{ completed: todo.complete }">
                        {{ todo.title }}
                        </div>
                    ...
                    <div class="todo-item-right">
                        <div class="todo-item-icon" @click="editTodo(todo)"><i class="fa-solid fa-pen"></i></div>
